...
var KEY = "32757716-8b0663aad2250c5619ecf300f";
var URL = "https://pixabay.com/api/?key=".concat(KEY);
var js_form = document.getElementById("search-form");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          notiflix_aio_3_2_5_min_default().Notify.failure("Sorry, No more images to load");
        case 13:
        case "end":
...
var processImages = function processImages(hits) {
  var images = hits.map(function (hit) {
    return "\n      <div class=\"photo-card\">\n\n                <a href=\"".concat(hit.largeImageURL, "\">\n                  <img  src=\"").concat(hit.webformatURL, "\" \n                   data-sorce=\"").concat(hit.largeImageURL, "\"\n                   alt=\"\"\n                   title=\"Upload by: ").concat(hit.user, "\"\n                   loading=\"lazy\" />\n                </a>\n\n                <div class=\"info\">\n                      <p class=\"info-item\">\n                        <b>Likes ").concat(hit.likes, "</b>\n                      </p>\n                      <p class=\"info-item\">\n                        <b>Views ").concat(hit.views, "</b>\n                      </p>\n                      <p class=\"info-item\">\n                        <b>Comments ").concat(hit.comments, "</b>\n                      </p>\n                      <p class=\"info-item\">\n                        <b>Downloads ").concat(hit.downloads, "</b>\n                      </p>\n                </div>;\n        </div>");
  }).join("");
  gallery.innerHTML += images;
};
function processData() {
  getData().then(function (h) {
    if (h.length > 0) {
      notiflix_aio_3_2_5_min_default().Notify.info("\"Hooray! We found ".concat(h.length, " images.\""));
      processImages(h);
      // load.style.display = "block";
      var g_img = new simple_lightbox_modules/* default */.Z(".gallery .photo-card a", {
        captions: true,
      ...
      notiflix_aio_3_2_5_min_default().Notify.failure("Sorry, there are no images matching your search query. Please try again.");
    }
  });
}
function smooth() {
...
js_form.addEventListener("submit", function (e) {
  e.preventDefault();
  gallery.innerHTML = "";
  var query = js_form.elements[0].value;
  if (!query) {
    notiflix_aio_3_2_5_min_default().Notify.warning("I cand find nothing with an empty query");
  } else {
